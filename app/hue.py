...
class HueAction:
    ...
    def action_lamp(self, lamp: int, state: Optional[bool] = None, bri: int = 254, hue: int =8895 , sat: int = 89) -> bool:
        ...
        if lamp_response:
            ...
            data = '{"on": true, "bri":' + str(bri) + ', "hue":' + str(hue) + ', "sat":' + str(sat) + '}' if new_state else '{"on": false}'
